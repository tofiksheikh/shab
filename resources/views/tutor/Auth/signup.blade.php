         ...
         <div class="row">
            <div class="col-xl-6 col-lg-7 col-md-9">
               ...
               <form method="post" id="signup">
                     @csrf
                     <input type="hidden" value="tutor" name="user_type">
               <div class="form-group">
                  <label for="f_name">Full Name</label>
                  <input type="text" name="name" value="" id="f_name" class="form-control l_validate l_required" err-text="Pleas Enter  Name" placeholder="Join Ecenter">
                  <i class="fa-regular fa-user common_icon"></i>
                  <i class="fa-sharp fa-regular fa-circle-check"></i>
               </div>
               <div class="form-group">
                  <label for="num">Mobile Number</label>
                  <input type="text" name="phone" value="" id="num"  class="form-control l_validate l_required cg_chkPhone"  err-text="Pleas Enter Phone Number" placeholder="+966 50 000 3030">
                  <i class="fa fa-phone common_icon"></i>
               </div>
                  <div class="form-group">
                  ...
                  <div class="btn_group">
                     <button type="submit" class="btn common_btn_link">Sign Up</button>
                     <a href="{{ url('tutor/signin')}}" class="btn create_account_btn">Already have an account?</a>
                  </div>
   ...
   function loginvalidate() {
      ...
      $('.l_validate').each(function(e) {
         ...
         if ($(this).hasClass('l_chkEmail')) {
            ...
            if( $(this).hasClass('cg_chkPhone') ) {
            var emRegex = /^[(]{0,1}[0-9]{3}[)]{0,1}[-\s\.]{0,1}[0-9]{3}[-\s\.]{0,1}[0-9]{4}$/;
                if( !emRegex.test($.trim($(this).val())) ) {
                    toastr.error('Phone Number should be correct.');
                    $(this).addClass("errorhover").css("border-color", "red")
                    $(this).focus();
                    err++;
                return false;
         ...
         //         var confirm_password = $('.check-confirm-password').val();
                 
         //         if(password!=confirm_password) {
         //                      $('.check-password').focus();
         //                      $('.check-password').addClass("errorhover").css("border-color", "red");
         //                      $('.check-confirm-password').addClass("errorhover").css("border-color", "red");
